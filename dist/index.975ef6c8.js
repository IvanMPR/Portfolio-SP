...
var _intersectionObserversJs = require("./js modules/intersectionObservers.js");
...
toggler.addEventListener("click", function() {
    if (this.checked) topMenu.style.top = "0";
    else topMenu.style.top = "-22rem";
});
// ------------------------------------------------------------------- //
...
const rightArrowAdvanced = document.querySelector(".frame-arrow__right--advanced");
const leftArrowAdvanced = document.querySelector(".frame-arrow__left--advanced");
const dotsContainerAdvanced = document.querySelector(".dots-container__advanced");
const data = {
    currentImage: 0,
...
function goToImage(projectsArray, imageNum) {
    projectsArray.forEach((img, i)=>img.style.transform = `translateX(${100 * (i - imageNum)}%`);
}
goToImage(images, 0);
...
function activateDot(currSlide, dotType) {
    document.querySelectorAll(`.${dotType}`).forEach((dot)=>dot.classList.remove("dot-active"));
    document.querySelector(`.${dotType}[data-image="${currSlide}"]`).classList.add("dot-active");
}
activateDot(0, "dot");
...
const homeObserver = new IntersectionObserver((0, _intersectionObserversJs.homeCallback), homeOptions);
...
const projectsObserver = new IntersectionObserver((0, _intersectionObserversJs.projectsCallback), projectsOptions);
...
const contactObserver = new IntersectionObserver((0, _intersectionObserversJs.contactCallback), contactOptions);
...
const aboutObserver = new IntersectionObserver((0, _intersectionObserversJs.aboutCallback), aboutOptions);
aboutObserver.observe(aboutSection);
function test() {
    console.log("test after form submit");
}

},{"./js modules/intersectionObservers.js":"7GNzB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7GNzB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "homeCallback", ()=>homeCallback);
parcelHelpers.export(exports, "projectsCallback", ()=>projectsCallback);
parcelHelpers.export(exports, "contactCallback", ()=>contactCallback);
parcelHelpers.export(exports, "aboutCallback", ()=>aboutCallback);
var _indexJs = require("../index.js");
function homeCallback(entries) {
    entries.forEach((entry)=>{
        if (entry.isIntersecting) {
            console.log("home");
            (0, _indexJs.links).forEach((link)=>{
...
},{"../index.js":"8lqZg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["igKGj","8lqZg"], "8lqZg", "parcelRequire0db1")
